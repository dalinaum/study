...
class UserPreferencesRepository(private val dataStore: DataStore<Preferences>) {
    ...
    val userPreferencesFlow: Flow<UserPreferences> = dataStore.data.catch { exception ->
        // dataStore.data throws an IOException when an error is encountered
        // when reading data
    ...
    suspend fun enableSortByDeadLine(enable: Boolean) {
        // edit handles data transactionally, ensuring that if the sort is updated
        // at the same time from another thread, we won't have conflicts.
        dataStore.edit { preferences ->
    ...
    suspend fun enabledSortByPriority(enable: Boolean) {
        // edit handles data transactionally, ensuring that if the sort is updated
        // at the same time from another thread, we won't have conflicts.
        dataStore.edit { preferences ->
            // Get the current SortOrder as an enum
